...
public:
    ...
    void setLookAt(glm::vec3 const& pos, glm::vec3 const& target, bool keepDistance = false);
    void setTarget(glm::vec3 const& target);
    void translateWithTarget(glm::vec3 const& target);
    void setPitchInDegree(float pitch);
...
public:
    ...
    glm::vec3 const& getForward() const { return mPhysical.forward; }
