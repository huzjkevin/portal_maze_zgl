...
struct v4usArray {
    arrayAdapter<v4us> adapter;
    v4usArray(const arrayAdapter<v4us> &a) : adapter(a) {}
    v4us operator[](size_t position) const { return adapter[position]; }
